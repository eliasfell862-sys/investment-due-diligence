...
describe('ProjectDashboardPage', () => {
  it('shows both report gates, review counts, formal missing fields, and the hold decision', () => {
    ...
    expect(screen.getByRole('heading', { name: '\u901f\u89c8\u62a5\u544a' })).toBeInTheDocument();
    expect(screen.getByRole('heading', { name: '\u5b8c\u6574\u5c3d\u8c03\u62a5\u544a' })).toBeInTheDocument();
    expect(screen.getByText(/2 \u9879\u5f85\u5ba1\u6838/)).toBeInTheDocument();
    expect(screen.queryByText(/\u7ec4\u672a\u89e3\u51b3/)).not.toBeInTheDocument();
    ...
    expect(screen.getByRole('button', { name: '\u5bfc\u51fa\u901f\u89c8\u62a5\u544a' })).toBeDisabled();
    expect(screen.getByRole('button', { name: '\u5bfc\u51fa\u5b8c\u6574\u5c3d\u8c03\u62a5\u544a' })).toBeDisabled();
  });
  ...
  it('shows a ready decision when the formal gate is satisfied', () => {
    ...
    expect(screen.getByText('\u5df2\u6ee1\u8db3\u5b8c\u6574\u62a5\u544a\u6761\u4ef6')).toBeInTheDocument();
  ...
  it('shows project context and a Data Room link when routed', () => {
    ...
    expect(screen.getByRole('link', { name: '\u8d44\u6599\u4e2d\u5fc3' })).toHaveAttribute(
      'href',
